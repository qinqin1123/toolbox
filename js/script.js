...
const DEFAULT_COMMENTS = {
    // ===== 搜索引擎 =====
    '百度': [
        { name:'明月清风', avatar:'明', text:'百度搜国内资讯真的方便，政策文件、新闻、本地生活都能找到，就是广告有点多，建议开启广告屏蔽插件一起用。', rating:4, time:'2026-04-15 09:22' },
        { name:'蓝天白云', avatar:'蓝', text:'用了十几年百度了，查中文内容还是它最全，公交路线、天气预报、周边餐厅，生活服务超方便。', rating:5, time:'2026-04-10 14:35' },
        { name:'晨星', avatar:'晨', text:'学术搜索的话建议用百度学术，普通搜索质量参差不齐，但作为日常入口还是很实用的。', rating:4, time:'2026-03-28 11:08' }
    ],
    '谷歌': [
        { name:'代码行者', avatar:'代', text:'查技术文档和英文资料谷歌是无可替代的，搜索结果质量远高于其他引擎，程序员必备。', rating:5, time:'2026-04-20 16:42' },
        { name:'学霸小李', avatar:'学', text:'论文检索、海外资料查找，谷歌学术加普通搜索的组合太强了，搭配VPN用体验满分。', rating:5, time:'2026-04-12 10:15' },
        { name:'旅行达人', avatar:'旅', text:'出国旅游必备，查当地交通、餐厅、景点全靠谷歌，地图也是一流的。', rating:5, time:'2026-03-30 08:55' }
    ],
    '必应': [
        { name:'办公小助手', avatar:'办', text:'国内能直接访问的国际搜索引擎首选，图片搜索质量非常高，每日壁纸也很漂亮！', rating:5, time:'2026-04-18 13:20' },
        { name:'微软粉', avatar:'微', text:'集成了Copilot AI，直接在搜索结果里就能得到AI总结，英文内容检索质量一流。', rating:4, time:'2026-04-05 17:33' },
        { name:'设计师小王', avatar:'设', text:'找高质量图片素材用必应图片搜索，分辨率过滤和版权过滤功能很实用。', rating:4, time:'2026-03-22 09:44' }
    ],
    'Perplexity AI': [
        { name:'研究员张博', avatar:'研', text:'AI搜索里体验最好的，每个回答都有来源引用，可信度高，深度研究问题非常高效。', rating:5, time:'2026-04-21 11:30' },
        { name:'信息控', avatar:'信', text:'替代传统搜索的最佳工具，追问功能特别好用，一个问题可以持续深挖，节省大量查资料的时间。', rating:5, time:'2026-04-08 15:50' },
        { name:'好奇宝宝', avatar:'好', text:'用来学新概念超方便，问完问题还可以继续问相关问题，像和专家对话一样。', rating:4, time:'2026-03-25 10:28' }
    ],
    '夸克搜索': [
        { name:'大学生小梦', avatar:'大', text:'学生党最爱，搜题搜资料都方便，和夸克网盘配合使用更是无敌，找资源效率极高！', rating:5, time:'2026-04-16 14:22' },
        { name:'无广告爱好者', avatar:'无', text:'首页干净无广告，搜索结果也相对纯净，比百度清爽多了，手机端体验尤其好。', rating:4, time:'2026-04-03 09:40' },
        { name:'考研党', avatar:'考', text:'搜学习资料、考研资源特别好用，网盘搜索功能能直接找到别人分享的资源，省了很多时间。', rating:4, time:'2026-03-20 16:15' }
    ],
    // ===== 在线工具 =====
    'TinyPNG': [
        { name:'前端开发者', avatar:'前', text:'压图神器！每次上传图片必用，70%的压缩率肉眼根本看不出差别，网站加载速度提升明显。', rating:5, time:'2026-04-19 10:08' },
        { name:'运营小姐姐', avatar:'运', text:'做公众号配图每次都用TinyPNG压一遍，排版更快加载更快，推荐给所有做内容的人。', rating:5, time:'2026-04-06 14:55' },
        { name:'摄影师老徐', avatar:'摄', text:'发邮件附件之前压一下，几MB的图片压完几百KB，对方打开超快，非常实用。', rating:4, time:'2026-03-18 11:22' }
    ],
    'Remove.bg': [
        { name:'电商美工', avatar:'电', text:'商品图抠背景太方便了，AI识别精度极高，连毛茸茸的边缘都处理得很干净，省了大量PS时间。', rating:5, time:'2026-04-22 09:30' },
        { name:'HR小李', avatar:'HR', text:'帮同事修证件照换背景，上传一张秒出结果，效果比我手动抠的好多了，强烈推荐！', rating:5, time:'2026-04-11 16:20' },
        { name:'自媒体作者', avatar:'自', text:'做封面图经常需要抠图，这个工具帮了我大忙，人像识别特别准，头发都抠得很干净。', rating:4, time:'2026-03-29 13:45' }
    ],
    'iLovePDF': [
        { name:'职场达人', avatar:'职', text:'PDF处理全靠它！合并、拆分、压缩、转Word都免费，界面简单，非程序员也能轻松上手。', rating:5, time:'2026-04-20 11:15' },
        { name:'行政小助手', avatar:'行', text:'每天都要处理各种PDF文件，iLovePDF真的救了我，再也不需要装那些臃肿的桌面软件了。', rating:5, time:'2026-04-09 15:30' },
        { name:'学生党小陈', avatar:'学', text:'论文PDF转Word改格式、拆分学习资料都用这个，完全免费，比买Adobe划算太多了。', rating:4, time:'2026-03-26 09:55' }
    ],
    'DeepL翻译': [
        { name:'翻译控', avatar:'翻', text:'翻译质量真的是市面上最好的，英译中读起来像人写的，完全不像机器翻译，学术写作必备！', rating:5, time:'2026-04-21 10:35' },
        { name:'留学生小周', avatar:'留', text:'读英文论文用DeepL翻译，再难的长句子翻出来也很通顺，比谷歌翻译强出一个档次。', rating:5, time:'2026-04-14 14:48' },
        { name:'外贸业务员', avatar:'外', text:'和外国客户沟通的邮件先用DeepL翻一遍再润色，效率提升了很多，客户说我英文写得不错哈哈。', rating:4, time:'2026-04-01 16:22' }
    ],
    'ProcessOn': [
        { name:'产品经理', avatar:'产', text:'画产品流程图必用ProcessOn，模板超多，和团队共享很方便，免费版9个图对我来说完全够用。', rating:5, time:'2026-04-18 09:55' },
        { name:'软件工程师', avatar:'软', text:'UML图、ER图、架构图全能画，支持多人协作，比Visio方便太多，而且是免费的！', rating:5, time:'2026-04-07 14:20' },
        { name:'老师小高', avatar:'老', text:'给学生讲课经常用来画知识结构图，清晰直观，学生反馈很好，推荐给所有教育工作者。', rating:4, time:'2026-03-24 11:40' }
    ],
    // ===== 设计素材 =====
    'Canva': [
        { name:'社群运营', avatar:'社', text:'完全改变了我的工作方式！以前做海报要等设计师，现在自己20分钟搞定，模板质量非常高。', rating:5, time:'2026-04-23 10:12' },
        { name:'小微企业主', avatar:'小', text:'开店做宣传图全靠Canva，一键套用模板修改文字图片，效果比请设计师做的还好看，而且免费！', rating:5, time:'2026-04-15 15:38' },
        { name:'学生会干部', avatar:'学', text:'活动宣传海报、社团招新海报都在Canva做，出来效果很漂亮，学姐都来问我在哪里做的。', rating:5, time:'2026-03-31 09:25' }
    ],
    'Figma': [
        { name:'UI设计师小林', avatar:'UI', text:'已经完全从Sketch迁移到Figma了，云端协作和Dev Mode让设计到开发的交接效率提升了一倍。', rating:5, time:'2026-04-22 14:30' },
        { name:'产品设计师', avatar:'产', text:'组件化设计和Auto Layout功能非常强大，做响应式设计效率极高，免费版对个人学习完全够用。', rating:5, time:'2026-04-16 11:25' },
        { name:'前端同学', avatar:'前', text:'设计师给的Figma稿，我直接在里面看标注、导出切图，再也不用来回沟通尺寸和颜色了。', rating:4, time:'2026-04-02 10:50' }
    ],
    'Unsplash': [
        { name:'博主小雨', avatar:'博', text:'写文章配图首选！每次都能找到高质量的图片，而且完全免费商用，不用担心版权问题。', rating:5, time:'2026-04-20 16:05' },
        { name:'PPT达人', avatar:'PP', text:'做PPT背景图就用Unsplash，风景、商务、科技各种风格都有，搜索出来质量都很高。', rating:5, time:'2026-04-13 09:18' },
        { name:'独立设计师', avatar:'独', text:'商业项目用图首选，图片质量不输付费图库，而且授权简单，客户完全不会有版权顾虑。', rating:5, time:'2026-03-27 14:44' }
    ],
    'Iconfont': [
        { name:'全栈开发者', avatar:'全', text:'前端项目必备！图标库之巨大令人惊叹，而且支持直接生成字体文件，项目集成超方便。', rating:5, time:'2026-04-21 11:20' },
        { name:'UI设计新人', avatar:'新', text:'入行第一个收藏的网站，中文界面友好，图标风格统一，搜索效率高，每天都在用。', rating:5, time:'2026-04-10 15:45' },
        { name:'小程序开发', avatar:'程', text:'做微信小程序必备资源站，图标风格和微信设计规范很搭，下载SVG直接用非常省时间。', rating:5, time:'2026-03-23 10:30' }
    ],
    // ===== 金融财经 =====
    '东方财富': [
        { name:'散户老刘', avatar:'刘', text:'炒股十年，东方财富是我用过最顺手的平台，行情数据及时，研报也多，开户买基金很方便。', rating:5, time:'2026-04-22 09:45' },
        { name:'基金投资者', avatar:'基', text:'天天基金就是它家的，买基金、看净值、查历史回报全在这里搞定，界面也不复杂。', rating:4, time:'2026-04-14 14:10' },
        { name:'财经研究生', avatar:'财', text:'写财经分析报告经常在东方财富找上市公司公告和财务数据，数据更新很及时，很实用。', rating:4, time:'2026-04-03 11:30' }
    ],
    '雪球': [
        { name:'价值投资者', avatar:'价', text:'雪球是我见过最有质量的投资社区，大V的分析文章专业性很高，学到了很多投资知识。', rating:5, time:'2026-04-19 10:55' },
        { name:'投资新手', avatar:'投', text:'刚开始学投资，雪球上的内容帮了我很多，组合功能可以看别人的持仓，学习参考价值很高。', rating:5, time:'2026-04-08 16:30' },
        { name:'股票分析师', avatar:'股', text:'上面有很多有真实持仓的投资者分享观点，比很多券商研报更接地气，是很好的信息来源。', rating:4, time:'2026-03-21 09:20' }
    ],
    // ===== 生活服务 =====
    '美团': [
        { name:'吃货小李', avatar:'吃', text:'外卖、团购、酒店、电影票一个App全搞定，优惠券经常有，外卖速度也快，生活必备App！', rating:5, time:'2026-04-22 12:30' },
        { name:'出差族', avatar:'出', text:'出差订酒店用美团，价格比携程便宜，配合神会员每月能省不少钱，强烈推荐开会员。', rating:4, time:'2026-04-13 18:20' },
        { name:'上班族小朱', avatar:'上', text:'午饭叫外卖全靠美团，附近餐厅一目了然，评价真实，下单到送到30分钟以内。', rating:5, time:'2026-03-29 12:05' }
    ],
    '高德地图': [
        { name:'驾驶爱好者', avatar:'驾', text:'导航精准度非常高，路况实时更新，红绿灯等待时间都能显示，开车必备，强推！', rating:5, time:'2026-04-21 08:30' },
        { name:'骑行党', avatar:'骑', text:'骑行路线规划超好用，可以专门选慢行道，再也不用担心走错路骑上高架了。', rating:5, time:'2026-04-12 17:45' },
        { name:'旅行达人', avatar:'旅', text:'去陌生城市必开高德，周边美食、景点、厕所都能搜到，生活服务信息比百度地图更丰富。', rating:4, time:'2026-04-01 14:22' }
    ],
    '12306': [
        { name:'常旅客', avatar:'常', text:'官方唯一正规购票渠道，回家过年必抢票，候补功能真的很好用，成功率比想象中高。', rating:4, time:'2026-04-18 09:10' },
        { name:'商务出行', avatar:'商', text:'高铁票购买方便，改签退票都在App里搞定，不用跑车站，功能越来越完善了。', rating:4, time:'2026-04-06 15:35' },
        { name:'学生党', avatar:'学', text:'买学生票必须用12306，优惠核验很方便，电子学生证也能直接验证，省了很多麻烦。', rating:4, time:'2026-03-24 11:50' }
    ],
    // ===== 网盘资源 =====
    '阿里云盘': [
        { name:'影视爱好者', avatar:'影', text:'不限速下载真的太爽了！存电影、下资料速度飞快，终于摆脱百度网盘的限速折磨了！', rating:5, time:'2026-04-23 10:45' },
        { name:'职场白领', avatar:'白', text:'工作文件备份同步全用阿里云盘，多设备同步流畅，界面也比百度简洁多了，推荐！', rating:5, time:'2026-04-15 14:20' },
        { name:'学习资料控', avatar:'资', text:'收集了大量学习资料存在阿里云盘，分享给同学也方便，容量大速度快，现在的主力云盘。', rating:5, time:'2026-04-04 09:35' }
    ],
    '百度网盘': [
        { name:'老用户小范', avatar:'老', text:'用了很多年，文件多、容量大，就是非会员下载速度太慢了，作为备份用还行。', rating:3, time:'2026-04-20 11:20' },
        { name:'资源分享者', avatar:'分', text:'社区里有很多人分享资源，找学习资料、影视资源经常在上面搜，资源量还是很大的。', rating:4, time:'2026-04-10 16:40' },
        { name:'文件管理控', avatar:'管', text:'个人重要文件备份用百度网盘，2TB空间够存好几年，稳定性也不错，就是下载要开会员。', rating:3, time:'2026-03-27 10:15' }
    ],
    '坚果云': [
        { name:'笔记达人', avatar:'笔', text:'Obsidian+坚果云WebDAV同步方案简直完美，多设备笔记实时同步，知识库管理神器！', rating:5, time:'2026-04-19 15:30' },
        { name:'学术研究者', avatar:'学', text:'Zotero文献库同步必用坚果云，WebDAV配置简单，多台电脑的文献库完全一致，强推！', rating:5, time:'2026-04-08 11:15' },
        { name:'数字游民', avatar:'数', text:'专业网盘就是不一样，同步稳定零出错，版本历史功能救过我几次，轻度用户免费完全够。', rating:4, time:'2026-03-26 09:50' }
    ],
    // ===== 影视娱乐 =====
    'B站': [
        { name:'知识UP主粉丝', avatar:'知', text:'B站已经不只是二次元了，各种知识区、纪录片、职场干货全都有，弹幕文化太有意思了！', rating:5, time:'2026-04-22 20:15' },
        { name:'编程学习者', avatar:'编', text:'学编程就靠B站！免费优质教程多到用不完，比买付费课程强多了，弹幕里还能看到别人踩过的坑。', rating:5, time:'2026-04-14 19:30' },
        { name:'动漫爱好者', avatar:'动', text:'追番必备，弹幕互动太有意思了，看别人的吐槽比剧情还好笑，B站是我每天必刷的App。', rating:5, time:'2026-04-05 21:45' }
    ],
    '抖音': [
        { name:'短视频创作者', avatar:'短', text:'流量扶持力度大，新账号也有机会涨粉，内容推荐算法精准，刷一刷停不下来。', rating:5, time:'2026-04-21 22:10' },
        { name:'日常用户', avatar:'日', text:'休闲娱乐首选，15秒到几分钟的视频刚好，等车等人的碎片时间用来刷抖音最合适了。', rating:4, time:'2026-04-13 19:55' },
        { name:'商家老板', avatar:'商', text:'做抖音直播带货效果不错，用户年龄层宽，推流稳定，功能也越来越完善了。', rating:4, time:'2026-04-02 16:40' }
    ],
    '网易云音乐': [
        { name:'音乐控', avatar:'音', text:'听歌推荐算法太懂我了！每日推荐每天必听，发现了很多宝藏小众歌手，评论区也很有意思。', rating:5, time:'2026-04-20 23:00' },
        { name:'情感表达者', avatar:'情', text:'网易云的评论区是真的有灵魂，有时候一条评论比歌词还让人感动，这是其他平台学不来的。', rating:5, time:'2026-04-12 21:30' },
        { name:'歌单收藏家', avatar:'歌', text:'精心整理的歌单功能超棒，关注别人的歌单能发现很多好音乐，分类整理自己的音乐库也很方便。', rating:4, time:'2026-04-01 20:15' }
    ],
    'Steam': [
        { name:'PC玩家', avatar:'PC', text:'游戏库无敌，每逢打折季买到手软，成就系统和好友互动功能很完善，PC游戏必备平台！', rating:5, time:'2026-04-21 22:45' },
        { name:'独立游戏爱好者', avatar:'独', text:'Steam上的独立游戏宝藏太多了，很多创意满满的小作品价格也不贵，每次打折都能挖到好东西。', rating:5, time:'2026-04-11 20:30' },
        { name:'主机转PC玩家', avatar:'主', text:'从主机转PC之后全靠Steam，游戏种类多，打折力度大，3A大作等等就能买到史低价。', rating:4, time:'2026-03-28 19:15' }
    ],
    // ===== PPT模板 =====
    '优品PPT': [
        { name:'职场新人', avatar:'职', text:'刚工作时靠优品PPT做了很多汇报，模板质量高，商务感强，套用之后改改文字就能用。', rating:5, time:'2026-04-19 10:20' },
        { name:'大学生小王', avatar:'大', text:'毕业答辩PPT就用这里的模板，同学都夸好看，关键是免费还不需要注册，太方便了！', rating:5, time:'2026-04-09 14:35' },
        { name:'培训师老张', avatar:'培', text:'做培训课件经常来找模板，风格多样，质量稳定，省了大量自己设计的时间。', rating:4, time:'2026-03-26 11:10' }
    ],
    '变色龙PPT': [
        { name:'设计爱好者', avatar:'设', text:'这里的PPT模板设计感很强，特别是科技感和商务风的，很多细节都处理得很精致。', rating:5, time:'2026-04-18 09:30' },
        { name:'品牌运营', avatar:'品', text:'给客户做提案PPT，在变色龙找到了很合适的风格，修改起来也方便，客户很满意！', rating:4, time:'2026-04-07 16:20' }
    ],
    '第一PPT': [
        { name:'老教师', avatar:'老', text:'用了很多年了，模板数量多，各种风格都有，对教育行业的课件设计特别友好，推荐！', rating:5, time:'2026-04-17 10:50' },
        { name:'行政文员', avatar:'行', text:'做年终总结和季度汇报常来这里找模板，简洁大方的商务风格很多，质量也不错。', rating:4, time:'2026-04-06 14:45' }
    ],
    'Slidesgo': [
        { name:'海外留学生', avatar:'海', text:'英文PPT必备！Slidesgo的模板设计感真的强，Google Slides和PowerPoint都支持，国际范满满。', rating:5, time:'2026-04-20 11:40' },
        { name:'UI设计师', avatar:'UI', text:'设计风格比国内大多数PPT网站好看很多，现代感强，配色专业，用来做设计提案很有说服力。', rating:5, time:'2026-04-10 15:25' },
        { name:'英语教师', avatar:'英', text:'做英语教学课件用Slidesgo，模板语言是英文的很合适，活泼的教育类模板很多。', rating:4, time:'2026-03-29 10:55' }
    ],
    // ===== Word文档 =====
    '办公资源网': [
        { name:'行政专员', avatar:'行', text:'公司各种Word合同、通知模板在这里全能找到，格式规范，直接改内容就能用，太省时间了！', rating:5, time:'2026-04-18 14:30' },
        { name:'HR经理', avatar:'HR', text:'员工手册、规章制度、劳动合同模板都找过，质量不错，节省了大量从头写文件的时间。', rating:4, time:'2026-04-08 10:15' }
    ],
    '模板王': [
        { name:'文员小晴', avatar:'文', text:'Word模板样式丰富，简历、报告、合同什么都有，新入职时靠这里解决了不少文档问题。', rating:4, time:'2026-04-16 15:20' },
        { name:'自由撰稿人', avatar:'自', text:'写作投稿用的排版模板在这里找，省了很多调格式的时间，专注内容就好。', rating:4, time:'2026-04-05 11:40' }
    ],
    // ===== Excel表格 =====
    'Excel之家': [
        { name:'财务人员', avatar:'财', text:'财务报表的公式、数据透视表技巧在这里都能学到，讲得很细致，工作效率提升了不少。', rating:5, time:'2026-04-21 09:25' },
        { name:'数据分析师', avatar:'数', text:'Excel函数和VBA教程质量很高，案例贴近工作实际，比很多付费课程讲得还透彻。', rating:5, time:'2026-04-13 14:50' },
        { name:'会计小朱', avatar:'会', text:'VLOOKUP、透视表、数组公式在这里都能找到详细教程，碰到不会的Excel问题首先来这里查。', rating:4, time:'2026-04-02 16:35' }
    ],
    '懒人Excel': [
        { name:'职场小白', avatar:'职', text:'讲得通俗易懂，我这种Excel零基础的看了也能学会，入门首选，强烈推荐！', rating:5, time:'2026-04-19 11:30' },
        { name:'运营专员', avatar:'运', text:'数据报表相关的技巧讲解得很实用，可以直接套用到工作中，学习效率高。', rating:4, time:'2026-04-09 15:55' }
    ],
    // ===== 思维导图 =====
    'XMind': [
        { name:'项目经理', avatar:'项', text:'团队头脑风暴和项目拆解必用XMind，逻辑结构清晰，导出格式多，和PPT结合使用效果很棒！', rating:5, time:'2026-04-22 10:05' },
        { name:'学生党小林', avatar:'学', text:'期末复习整理知识框架全靠XMind，比手写导图好看很多，打印出来贴书桌上效果一流！', rating:5, time:'2026-04-15 16:45' },
        { name:'产品设计师', avatar:'产', text:'产品功能梳理和用户旅程图用XMind做，层次清晰，和团队沟通也很方便，强烈推荐。', rating:4, time:'2026-04-05 11:20' }
    ],
    '幕布': [
        { name:'读书达人', avatar:'读', text:'读书笔记神器！大纲和思维导图双视图切换太方便了，整理书的核心逻辑非常清晰。', rating:5, time:'2026-04-20 21:30' },
        { name:'内容创作者', avatar:'内', text:'写文章先在幕布整理框架，然后展开写作，思路更清晰，产出效率提升很明显。', rating:4, time:'2026-04-11 14:25' }
    ],
    '百度脑图': [
        { name:'国内用户', avatar:'国', text:'完全免费，国内访问速度快，基础功能够用，简单的思维导图绘制首选，零学习成本。', rating:4, time:'2026-04-17 10:40' },
        { name:'老师小孙', avatar:'老', text:'给学生布置思维导图作业用这个，免费好用，学生学起来也快，推荐给同行教师。', rating:4, time:'2026-04-06 09:30' }
    ],
    // ===== 学术科研 =====
    '知网': [
        { name:'研究生小陈', avatar:'研', text:'中文文献必备，知网的覆盖面无可替代，写论文查文献少不了它，只是下载要收费有点贵。', rating:4, time:'2026-04-21 10:15' },
        { name:'学术爱好者', avatar:'学', text:'研究中文学术动态首选，可以看到最新发表的论文，了解领域前沿很方便。', rating:4, time:'2026-04-12 15:40' }
    ],
    'Google Scholar': [
        { name:'博士研究生', avatar:'博', text:'英文文献检索无可替代，引用数量、相关文章一目了然，还能直接搜到免费版本，学术必备！', rating:5, time:'2026-04-20 14:25' },
        { name:'科研工作者', avatar:'科', text:'找某个研究领域的奠基论文、高引文章非常高效，被引关系分析很有用，科研必备工具。', rating:5, time:'2026-04-11 11:50' }
    ],
    'Sci-Hub': [
        { name:'穷学生', avatar:'穷', text:'解决付费论文获取问题的神器，再贵的期刊文章粘贴DOI就能下载，学术研究省了很多钱。', rating:5, time:'2026-04-19 16:30' },
        { name:'独立研究者', avatar:'独', text:'没有机构权限的研究者的福音，能获取到否则无法阅读的大量文献，学术开放获取应该是趋势。', rating:5, time:'2026-04-09 10:20' }
    ],
    'arXiv': [
        { name:'AI研究员', avatar:'AI', text:'AI/ML领域最新研究第一时间都在arXiv发，比期刊发表早几个月甚至更久，必须每天刷一刷！', rating:5, time:'2026-04-23 09:40' },
        { name:'数学系学生', avatar:'数', text:'数学、物理、计算机的最新预印本全在这里，完全免费，而且可以看到稿件修改历史，很透明。', rating:5, time:'2026-04-14 14:55' }
    ],
    // ===== AI工具 =====
    'ChatGPT': [
        { name:'程序员老赵', avatar:'程', text:'写代码、调Bug、查文档用ChatGPT效率提升了不止3倍！解释概念、生成脚本都非常在行。', rating:5, time:'2026-04-22 11:30' },
        { name:'内容创作者', avatar:'内', text:'写文案、整理思路、头脑风暴全靠它，GPT-4o的能力真的强，已经融入我工作的每个环节了。', rating:5, time:'2026-04-15 16:00' },
        { name:'英语学习者', avatar:'英', text:'当英语老师太好用了，纠错、改写、解释语法都能做，比任何APP都实用，强烈推荐！', rating:5, time:'2026-04-06 20:15' }
    ],
    'Claude': [
        { name:'写作爱好者', avatar:'写', text:'长文本理解能力太强了！给Claude一篇长报告让它总结分析，逻辑清晰，比ChatGPT更擅长写作。', rating:5, time:'2026-04-21 14:20' },
        { name:'法务人员', avatar:'法', text:'阅读合同、分析条款用Claude非常好，细节把握准确，语言表达也更专业，工作神器。', rating:5, time:'2026-04-13 10:35' }
    ],
    '文心一言': [
        { name:'国内用户小赵', avatar:'赵', text:'国内访问最流畅的AI助手之一，中文理解和生成能力很强，处理中文文档比英文AI更好。', rating:4, time:'2026-04-20 09:50' },
        { name:'企业员工', avatar:'企', text:'公司内部写材料、做总结、起草通知都靠文心一言，完全不需要翻墙，使用很方便。', rating:4, time:'2026-04-11 15:20' }
    ],
    '通义千问': [
        { name:'阿里云用户', avatar:'阿', text:'和阿里云服务集成很好，做企业客服和文档处理很方便，对中文语境理解很好。', rating:4, time:'2026-04-18 10:30' },
        { name:'开发者小吴', avatar:'开', text:'开源模型拿来本地部署很方便，API调用文档清晰，国内大模型里代码能力不错。', rating:4, time:'2026-04-07 14:45' }
    ],
    'Midjourney': [
        { name:'创意设计师', avatar:'创', text:'AI生图质量最高的工具！商业插画、概念设计用它，出图质量让客户叹为观止，完全改变了我的工作方式。', rating:5, time:'2026-04-23 10:25' },
        { name:'自媒体博主', avatar:'自', text:'封面图、配图全靠Midjourney，指令熟练了之后出图效率极高，比买素材便宜多了。', rating:5, time:'2026-04-16 17:10' }
    ],
    'Stable Diffusion': [
        { name:'技术极客', avatar:'技', text:'本地部署完全免费，模型生态丰富，ControlNet精确控制图像，功能比商业产品更强大！', rating:5, time:'2026-04-19 15:45' },
        { name:'游戏美术', avatar:'游', text:'游戏概念图快速出稿必备，搭配LoRA模型可以保持角色一致性，工业级别的效率工具。', rating:5, time:'2026-04-10 11:30' }
    ],
    'Notion AI': [
        { name:'效率工具控', avatar:'效', text:'笔记里直接调用AI太方便了，写作辅助、总结笔记、脑暴想法无缝衔接，效率神器！', rating:5, time:'2026-04-21 16:40' },
        { name:'产品经理小刘', avatar:'产', text:'在Notion写文档的时候用AI润色和补充内容，工作流完全不中断，比来回切App方便太多。', rating:4, time:'2026-04-12 10:55' }
    ],
    // ===== 简历求职 =====
    '超级简历': [
        { name:'应届毕业生', avatar:'应', text:'用超级简历做出来的简历真的很好看，ATS优化功能帮助通过了很多大厂的初筛，成功率提升很明显！', rating:5, time:'2026-04-22 10:30' },
        { name:'转行者小林', avatar:'转', text:'换工作用超级简历改了一版，面试邀约数量明显增加，排版专业简洁，HR反馈很好。', rating:5, time:'2026-04-14 15:40' }
    ],
    '简历蛋': [
        { name:'职场小白', avatar:'职', text:'模板好看免费，操作简单，导出PDF格式完美，第一份正式简历就是用简历蛋做的！', rating:4, time:'2026-04-17 11:20' },
        { name:'毕业生小陈', avatar:'毕', text:'免费模板质量就已经很好了，不需要付费就能做出漂亮的简历，强烈推荐给同学们。', rating:4, time:'2026-04-07 14:30' }
    ],
    'Boss直聘': [
        { name:'求职者小张', avatar:'求', text:'直接和Boss聊天的模式效率极高，沟通速度快，比投递简历等回复节省很多时间，强烈推荐！', rating:5, time:'2026-04-20 10:15' },
        { name:'产品经理', avatar:'产', text:'互联网岗位必用！职位信息新鲜，直接和负责人沟通更了解公司需求，面试成功率更高。', rating:5, time:'2026-04-13 16:45' },
        { name:'应届生小梦', avatar:'应', text:'第一份工作就是在Boss上找到的，校招专区信息多，每天刷新职位，主动出击效果好。', rating:4, time:'2026-04-04 11:30' }
    ],
    '智联招聘': [
        { name:'资深HR', avatar:'HR', text:'招聘岗位发布在智联，简历库很大，背景调查功能也很完善，是我们公司主要的招聘渠道之一。', rating:4, time:'2026-04-18 09:45' },
        { name:'求职者小高', avatar:'小', text:'岗位量很多，传统企业用智联的多，简历投递后有AI匹配推荐，找到了现在的工作。', rating:4, time:'2026-04-08 15:30' }
    ],
    // ===== 公考考编 =====
    '粉笔公考': [
        { name:'备考生小余', avatar:'备', text:'行测和申论题库量非常大，AI智能分析弱点，刷题效率比纸质题册高多了，每天坚持做题进步明显！', rating:5, time:'2026-04-22 08:30' },
        { name:'上岸学姐', avatar:'上', text:'省考靠粉笔刷题上岸，模拟考试系统很真实，错题本功能帮助我精准补弱，强烈推荐！', rating:5, time:'2026-04-15 10:45' }
    ],
    '华图教育': [
        { name:'考公战士', avatar:'考', text:'华图的押题和真题解析很准，老师讲解清晰，配合粉笔刷题一起用效果更好。', rating:4, time:'2026-04-19 09:20' },
        { name:'事业单位考生', avatar:'事', text:'事业编考试资料很全，历年真题和解析质量高，价格也不贵，性价比高。', rating:4, time:'2026-04-10 14:35' }
    ],
    '国家公务员局': [
        { name:'考公必备', avatar:'考', text:'报名、查分、查成绩唯一官方渠道，公告第一时间在这里发布，考公必须收藏！', rating:5, time:'2026-04-21 09:00' },
        { name:'备考老兵', avatar:'备', text:'国考报名季每天必刷，考情通知最权威，职位表下载必须来官网，不要相信第三方。', rating:5, time:'2026-04-12 08:45' }
    ],
    // ===== 编程学习 =====
    'GitHub': [
        { name:'开源贡献者', avatar:'开', text:'代码托管、版本管理、开源协作全在这里，现代软件开发最重要的基础设施，每天都离不开！', rating:5, time:'2026-04-23 09:15' },
        { name:'学生开发者', avatar:'学', text:'学编程就从在GitHub找项目学起，Issues区提问也能学到很多，还能展示自己的作品集。', rating:5, time:'2026-04-16 14:20' },
        { name:'全栈工程师', avatar:'全', text:'GitHub Actions自动化部署、Copilot AI辅助编程，GitHub已经是开发者最强的工具平台了。', rating:5, time:'2026-04-07 10:35' }
    ],
    'Stack Overflow': [
        { name:'程序员小朱', avatar:'程', text:'遇到编程问题先谷歌，多半会跳到Stack Overflow，几乎所有常见问题都能找到答案，编程必备！', rating:5, time:'2026-04-22 11:45' },
        { name:'前端开发', avatar:'前', text:'JS/CSS各种奇怪的bug在这里都能找到解决方案，高赞答案质量很高，节省了我无数小时。', rating:5, time:'2026-04-15 16:30' }
    ],
    'LeetCode': [
        { name:'求职刷题党', avatar:'求', text:'面试前刷LeetCode是必经之路，题目覆盖全面，题解质量高，企业面试考题高度重叠，刷就对了！', rating:5, time:'2026-04-21 21:30' },
        { name:'算法爱好者', avatar:'算', text:'每天打卡做一题，算法思维越来越好，周赛的题目难度适中，挑战性和学习效果都很棒。', rating:5, time:'2026-04-14 20:15' }
    ],
    'MDN Web Docs': [
        { name:'前端开发者', avatar:'前', text:'Web标准文档最权威的参考，HTML/CSS/JS API全覆盖，每次查API文档和浏览器兼容性必来这里！', rating:5, time:'2026-04-20 10:40' },
        { name:'Web学习者', avatar:'学', text:'教程和参考文档写得都很清晰，示例代码可以直接运行，学Web开发最好的免费资源之一。', rating:5, time:'2026-04-11 14:25' }
    ],
    'Vue.js官网': [
        { name:'前端工程师', avatar:'前', text:'Vue文档写得是国内最清楚的前端框架文档之一，中文版很完整，新手友好，上手非常快！', rating:5, time:'2026-04-19 15:20' },
        { name:'小程序开发者', avatar:'小', text:'Vue3的Composition API学了之后再也回不去了，官网的迁移指南写得很详细，帮助很大。', rating:5, time:'2026-04-09 11:50' }
    ],
    '菜鸟教程': [
        { name:'编程入门者', avatar:'编', text:'学各种语言基础语法首选，教程简洁易懂，在线运行代码功能太方便了，国内访问速度快！', rating:5, time:'2026-04-18 10:30' },
        { name:'全栈学习者', avatar:'全', text:'Python、Java、前端、数据库全套教程都有，知识点全面，查语法用法来这里比搜索快多了。', rating:4, time:'2026-04-08 15:45' }
    ],
    'Coursera': [
        { name:'自学程序员', avatar:'自', text:'Stanford、MIT的名校课程在家就能上，机器学习课程质量顶级，证书全球认可，性价比很高！', rating:5, time:'2026-04-22 14:50' },
        { name:'职场进修者', avatar:'职', text:'工作之余在Coursera学AI和数据分析，课程系统全面，学完拿证书对晋升很有帮助。', rating:4, time:'2026-04-14 18:30' }
    ],
    'freeCodeCamp': [
        { name:'转行者小杨', avatar:'转', text:'完全免费学编程！前端到后端、数据科学到机器学习全覆盖，项目实战为主，学了就能用！', rating:5, time:'2026-04-21 20:15' },
        { name:'编程公益支持者', avatar:'公', text:'非营利组织做出来的学习平台比很多商业产品还好，免费开放给所有人，精神可嘉内容也很赞！', rating:5, time:'2026-04-12 19:30' }
    ],
    'Python官网': [
        { name:'数据科学家', avatar:'数', text:'Python官方文档写得很完整，标准库和内置函数查文档首选，比任何第三方教程都权威准确。', rating:5, time:'2026-04-20 11:25' },
        { name:'爬虫工程师', avatar:'爬', text:'Requests、BeautifulSoup的文档也很清晰，官网提供的包索引能找到几乎所有第三方库。', rating:4, time:'2026-04-10 14:40' }
    ],
    // ===== 大学生创业 =====
    '36氪': [
        { name:'创业者小魏', avatar:'创', text:'了解创业项目动态和融资信息的最好渠道，Pre-A之前的早期项目信息量非常大，必读！', rating:5, time:'2026-04-21 09:35' },
        { name:'投资爱好者', avatar:'投', text:'科技创业资讯最全面的中文媒体，融资信息、行业趋势、创始人访谈质量都很高，每天必看。', rating:4, time:'2026-04-13 14:20' }
    ],
    '天眼查': [
        { name:'商业尽调', avatar:'商', text:'查公司背景必备！工商信息、法律诉讼、关联企业一览无余，做商务合作前必须查一查。', rating:5, time:'2026-04-20 10:50' },
        { name:'求职参考者', avatar:'求', text:'面试前查一下公司的工商信息、是否有劳动纠纷，比盲目去面试安全多了，推荐！', rating:4, time:'2026-04-11 15:30' }
    ]
};

// 预置默认评论（每个资源仅在无评论时初始化一次）
function initDefaultComments() {
    Object.keys(DEFAULT_COMMENTS).forEach(function(resName) {
        var key = 'toolbox_comments_' + resName;
        if (!localStorage.getItem(key)) {
            localStorage.setItem(key, JSON.stringify(DEFAULT_COMMENTS[resName]));
        }
    });
}
initDefaultComments();
